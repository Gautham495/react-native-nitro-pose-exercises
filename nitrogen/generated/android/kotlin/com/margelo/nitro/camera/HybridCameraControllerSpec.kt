...
abstract class HybridCameraControllerSpec: HybridObject() {
  ...
  @get:DoNotStrip
  @get:Keep
  abstract val device: com.margelo.nitro.camera.HybridCameraDeviceSpec
  ...
  @DoNotStrip
  @Keep
  abstract fun focusTo(point: com.margelo.nitro.camera.HybridMeteringPointSpec, options: FocusOptions): Promise<Unit>
