...
data class CapturePhotoSettings(
  ...
  @DoNotStrip
  @Keep
  val location: com.margelo.nitro.camera.HybridLocationSpec?
) {
  /* primary constructor */
  ...
  companion object {
    ...
    @Suppress("unused")
    @JvmStatic
    private fun fromCpp(flashMode: FlashMode?, enableShutterSound: Boolean?, enableDepthData: Boolean?, enableRedEyeReduction: Boolean?, enableCameraCalibrationDataDelivery: Boolean?, enableDistortionCorrection: Boolean?, enableVirtualDeviceFusion: Boolean?, location: com.margelo.nitro.camera.HybridLocationSpec?): CapturePhotoSettings {
