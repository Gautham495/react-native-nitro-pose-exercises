...
namespace margelo::nitro::camera {
  ...
  std::vector<std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>> JHybridCameraDeviceSpec::getPhysicalDevices() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<margelo::nitro::camera::JHybridCameraDeviceSpec::JavaPart>>()>("getPhysicalDevices");
    auto __result = method(_javaPart);
    return [&](auto&& __input) {
  ...
  std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>> JHybridCameraDeviceSpec::getCompanionDeskViewCamera() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<margelo::nitro::camera::JHybridCameraDeviceSpec::JavaPart>()>("getCompanionDeskViewCamera");
    auto __result = method(_javaPart);
  ...
  bool JHybridCameraDeviceSpec::supportsOutput(const std::shared_ptr<margelo::nitro::camera::HybridCameraOutputSpec>& output) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jboolean(jni::alias_ref<margelo::nitro::camera::JHybridCameraOutputSpec::JavaPart> /* output */)>("supportsOutput");
    auto __result = method(_javaPart, std::dynamic_pointer_cast<margelo::nitro::camera::JHybridCameraOutputSpec>(output)->getJavaPart());
    return static_cast<bool>(__result);
  }
  ...
  bool JHybridCameraDeviceSpec::isSessionConfigSupported(const std::shared_ptr<margelo::nitro::camera::HybridCameraSessionConfigSpec>& config) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jboolean(jni::alias_ref<margelo::nitro::camera::JHybridCameraSessionConfigSpec::JavaPart> /* config */)>("isSessionConfigSupported");
    auto __result = method(_javaPart, std::dynamic_pointer_cast<margelo::nitro::camera::JHybridCameraSessionConfigSpec>(config)->getJavaPart());
    return static_cast<bool>(__result);
  }
