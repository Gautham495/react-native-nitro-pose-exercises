...
namespace margelo::nitro::camera {
  ...
  class JHybridCameraPhotoOutputSpec: public virtual HybridCameraPhotoOutputSpec, public virtual margelo::nitro::camera::JHybridCameraOutputSpec {
  public:
  ...
  public:
    // Methods
    std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridPhotoSpec>>> capturePhoto(const CapturePhotoSettings& settings, const CapturePhotoCallbacks& callbacks) override;
