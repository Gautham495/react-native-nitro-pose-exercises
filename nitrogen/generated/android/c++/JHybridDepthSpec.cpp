...
#include <optional>
#include <VisionCamera/JHybridCameraCalibrationDataSpec.hpp>
...
namespace margelo::nitro::camera {
  ...
  std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraCalibrationDataSpec>> JHybridDepthSpec::getCameraCalibrationData() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<margelo::nitro::camera::JHybridCameraCalibrationDataSpec::JavaPart>()>("getCameraCalibrationData");
    auto __result = method(_javaPart);
  ...
  std::shared_ptr<margelo::nitro::camera::HybridDepthSpec> JHybridDepthSpec::rotate(CameraOrientation orientation, bool isMirrored) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<margelo::nitro::camera::JHybridDepthSpec::JavaPart>(jni::alias_ref<JCameraOrientation> /* orientation */, jboolean /* isMirrored */)>("rotate");
    auto __result = method(_javaPart, JCameraOrientation::fromCpp(orientation), isMirrored);
    return __result->getJHybridDepthSpec();
  }
  std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridDepthSpec>>> JHybridDepthSpec::rotateAsync(CameraOrientation orientation, bool isMirrored) {
    ...
    auto __result = method(_javaPart, JCameraOrientation::fromCpp(orientation), isMirrored);
    return [&]() {
      auto __promise = Promise<std::shared_ptr<margelo::nitro::camera::HybridDepthSpec>>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
        auto __result = jni::static_ref_cast<margelo::nitro::camera::JHybridDepthSpec::JavaPart>(__boxedResult);
  ...
  std::shared_ptr<margelo::nitro::camera::HybridDepthSpec> JHybridDepthSpec::convert(DepthPixelFormat pixelFormat) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<margelo::nitro::camera::JHybridDepthSpec::JavaPart>(jni::alias_ref<JDepthPixelFormat> /* pixelFormat */)>("convert");
    auto __result = method(_javaPart, JDepthPixelFormat::fromCpp(pixelFormat));
    return __result->getJHybridDepthSpec();
  }
  std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridDepthSpec>>> JHybridDepthSpec::convertAsync(DepthPixelFormat pixelFormat) {
  ...
  std::shared_ptr<margelo::nitro::camera::HybridFrameSpec> JHybridDepthSpec::toFrame() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<margelo::nitro::camera::JHybridFrameSpec::JavaPart>()>("toFrame");
    auto __result = method(_javaPart);
    return __result->getJHybridFrameSpec();
  }
  std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridFrameSpec>>> JHybridDepthSpec::toFrameAsync() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("toFrameAsync");
    auto __result = method(_javaPart);
    return [&]() {
      auto __promise = Promise<std::shared_ptr<margelo::nitro::camera::HybridFrameSpec>>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
        auto __result = jni::static_ref_cast<margelo::nitro::camera::JHybridFrameSpec::JavaPart>(__boxedResult);
