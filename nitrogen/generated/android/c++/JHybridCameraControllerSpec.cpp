...
namespace margelo::nitro::camera {
  ...
  // Properties
  std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec> JHybridCameraControllerSpec::getDevice() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<margelo::nitro::camera::JHybridCameraDeviceSpec::JavaPart>()>("getDevice");
  ...
  std::shared_ptr<Promise<void>> JHybridCameraControllerSpec::focusTo(const std::shared_ptr<margelo::nitro::camera::HybridMeteringPointSpec>& point, const FocusOptions& options) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<margelo::nitro::camera::JHybridMeteringPointSpec::JavaPart> /* point */, jni::alias_ref<JFocusOptions> /* options */)>("focusTo");
    auto __result = method(_javaPart, std::dynamic_pointer_cast<margelo::nitro::camera::JHybridMeteringPointSpec>(point)->getJavaPart(), JFocusOptions::fromCpp(options));
    return [&]() {
      auto __promise = Promise<void>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& /* unit */) {
        __promise->resolve();
