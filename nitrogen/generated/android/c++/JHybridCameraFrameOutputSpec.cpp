...
namespace margelo::nitro::camera {
  ...
  // Properties
  std::shared_ptr<margelo::nitro::camera::HybridNativeThreadSpec> JHybridCameraFrameOutputSpec::getThread() {
  ...
  // Methods
  void JHybridCameraFrameOutputSpec::setOnFrameCallback(const std::optional<std::function<bool(const std::shared_ptr<margelo::nitro::camera::HybridFrameSpec>& /* frame */)>>& onFrame) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void(jni::alias_ref<JFunc_bool_std__shared_ptr_margelo__nitro__camera__HybridFrameSpec_::javaobject> /* onFrame */)>("setOnFrameCallback_cxx");
    method(_javaPart, onFrame.has_value() ? JFunc_bool_std__shared_ptr_margelo__nitro__camera__HybridFrameSpec__cxx::fromCpp(onFrame.value()) : nullptr);
  }
