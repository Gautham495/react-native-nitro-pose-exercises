...
namespace margelo::nitro::camera {
  ...
  // Properties
  std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraPreviewOutputSpec>> JHybridPreviewViewSpec::getPreviewOutput() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<margelo::nitro::camera::JHybridCameraPreviewOutputSpec::JavaPart>()>("getPreviewOutput");
    auto __result = method(_javaPart);
    return __result != nullptr ? std::make_optional(__result->getJHybridCameraPreviewOutputSpec()) : std::nullopt;
  }
  void JHybridPreviewViewSpec::setPreviewOutput(const std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraPreviewOutputSpec>>& previewOutput) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void(jni::alias_ref<margelo::nitro::camera::JHybridCameraPreviewOutputSpec::JavaPart> /* previewOutput */)>("setPreviewOutput");
    method(_javaPart, previewOutput.has_value() ? std::dynamic_pointer_cast<margelo::nitro::camera::JHybridCameraPreviewOutputSpec>(previewOutput.value())->getJavaPart() : nullptr);
  }
  ...
  std::optional<std::vector<std::shared_ptr<margelo::nitro::camera::HybridGestureControllerSpec>>> JHybridPreviewViewSpec::getGestureControllers() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<margelo::nitro::camera::JHybridGestureControllerSpec::JavaPart>>()>("getGestureControllers");
    auto __result = method(_javaPart);
    return __result != nullptr ? std::make_optional([&](auto&& __input) {
      size_t __size = __input->size();
      std::vector<std::shared_ptr<margelo::nitro::camera::HybridGestureControllerSpec>> __vector;
  ...
  void JHybridPreviewViewSpec::setGestureControllers(const std::optional<std::vector<std::shared_ptr<margelo::nitro::camera::HybridGestureControllerSpec>>>& gestureControllers) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void(jni::alias_ref<jni::JArrayClass<margelo::nitro::camera::JHybridGestureControllerSpec::JavaPart>> /* gestureControllers */)>("setGestureControllers");
    method(_javaPart, gestureControllers.has_value() ? [&](auto&& __input) {
      size_t __size = __input.size();
      jni::local_ref<jni::JArrayClass<margelo::nitro::camera::JHybridGestureControllerSpec::JavaPart>> __array = jni::JArrayClass<margelo::nitro::camera::JHybridGestureControllerSpec::JavaPart>::newArray(__size);
      for (size_t __i = 0; __i < __size; __i++) {
        const auto& __element = __input[__i];
        auto __elementJni = std::dynamic_pointer_cast<margelo::nitro::camera::JHybridGestureControllerSpec>(__element)->getJavaPart();
  ...
  // Methods
  std::shared_ptr<margelo::nitro::camera::HybridMeteringPointSpec> JHybridPreviewViewSpec::createMeteringPoint(double viewX, double viewY, std::optional<double> size) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<margelo::nitro::camera::JHybridMeteringPointSpec::JavaPart>(double /* viewX */, double /* viewY */, jni::alias_ref<jni::JDouble> /* size */)>("createMeteringPoint");
  ...
  std::shared_ptr<margelo::nitro::camera::HybridScannedObjectSpec> JHybridPreviewViewSpec::convertScannedObjectCoordinatesToViewCoordinates(const std::shared_ptr<margelo::nitro::camera::HybridScannedObjectSpec>& scannedObject) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<margelo::nitro::camera::JHybridScannedObjectSpec::JavaPart>(jni::alias_ref<margelo::nitro::camera::JHybridScannedObjectSpec::JavaPart> /* scannedObject */)>("convertScannedObjectCoordinatesToViewCoordinates");
    auto __result = method(_javaPart, std::dynamic_pointer_cast<margelo::nitro::camera::JHybridScannedObjectSpec>(scannedObject)->getJavaPart());
