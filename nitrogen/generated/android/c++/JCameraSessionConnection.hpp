...
namespace margelo::nitro::nitroposeexercises {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitroposeexercises/CameraSessionConnection;";
  ...
  public:
    ...
    CameraSessionConnection toCpp() const {
      ...
      static const auto fieldInput = clazz->getField<margelo::nitro::camera::JHybridCameraDeviceSpec::JavaPart>("input");
      jni::local_ref<margelo::nitro::camera::JHybridCameraDeviceSpec::JavaPart> input = this->getFieldValue(fieldInput);
      ...
      static const auto fieldOnSessionConfigSelected = clazz->getField<JFunc_void_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec_::javaobject>("onSessionConfigSelected");
      jni::local_ref<JFunc_void_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec_::javaobject> onSessionConfigSelected = this->getFieldValue(fieldOnSessionConfigSelected);
      return CameraSessionConnection(
        ...
        onSessionConfigSelected != nullptr ? std::make_optional([&]() -> std::function<void(const std::shared_ptr<margelo::nitro::camera::HybridCameraSessionConfigSpec>& /* config */)> {
          if (onSessionConfigSelected->isInstanceOf(JFunc_void_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec__cxx::javaClassStatic())) [[likely]] {
            auto downcast = jni::static_ref_cast<JFunc_void_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec__cxx::javaobject>(onSessionConfigSelected);
            return downcast->cthis()->getFunction();
          } else {
            auto onSessionConfigSelectedRef = jni::make_global(onSessionConfigSelected);
            return JNICallable<JFunc_void_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec_, void(std::shared_ptr<margelo::nitro::camera::HybridCameraSessionConfigSpec>)>(std::move(onSessionConfigSelectedRef));
          }
        }()) : std::nullopt
      );
    }
  ...
  public:
    ...
    static jni::local_ref<JCameraSessionConnection::javaobject> fromCpp(const CameraSessionConnection& value) {
      using JSignature = JCameraSessionConnection(jni::alias_ref<margelo::nitro::camera::JHybridCameraDeviceSpec::JavaPart>, jni::alias_ref<jni::JArrayClass<JCameraOutputConfiguration>>, jni::alias_ref<jni::JArrayClass<JConstraint>>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<JFunc_void_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec_::javaobject>);
      static const auto clazz = javaClassStatic();
      static const auto create = clazz->getStaticMethod<JSignature>("fromCpp");
      return create(
        clazz,
        std::dynamic_pointer_cast<margelo::nitro::camera::JHybridCameraDeviceSpec>(value.input)->getJavaPart(),
        [&](auto&& __input) {
          size_t __size = __input.size();
        ...
        value.onSessionConfigSelected.has_value() ? JFunc_void_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec__cxx::fromCpp(value.onSessionConfigSelected.value()) : nullptr
      );
    }
  };
