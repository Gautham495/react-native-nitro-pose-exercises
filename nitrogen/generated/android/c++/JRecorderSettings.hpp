...
namespace margelo::nitro::nitroposeexercises {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitroposeexercises/RecorderSettings;";
  ...
  public:
    ...
    static jni::local_ref<JRecorderSettings::javaobject> fromCpp(const RecorderSettings& value) {
      using JSignature = JRecorderSettings(jni::alias_ref<margelo::nitro::camera::JHybridLocationSpec::JavaPart>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>);
      static const auto clazz = javaClassStatic();
