...
namespace margelo::nitro::image {
  ...
  std::optional<std::variant<std::shared_ptr<margelo::nitro::image::HybridImageSpec>, std::shared_ptr<margelo::nitro::image::HybridImageLoaderSpec>>> JHybridNitroImageViewSpec::getImage() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JVariant_com_margelo_nitro_image_HybridImageSpec_com_margelo_nitro_image_HybridImageLoaderSpec>()>("getImage");
  ...
  void JHybridNitroImageViewSpec::setImage(const std::optional<std::variant<std::shared_ptr<margelo::nitro::image::HybridImageSpec>, std::shared_ptr<margelo::nitro::image::HybridImageLoaderSpec>>>& image) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void(jni::alias_ref<JVariant_com_margelo_nitro_image_HybridImageSpec_com_margelo_nitro_image_HybridImageLoaderSpec> /* image */)>("setImage");
    method(_javaPart, image.has_value() ? JVariant_com_margelo_nitro_image_HybridImageSpec_com_margelo_nitro_image_HybridImageLoaderSpec::fromCpp(image.value()) : nullptr);
  }
