...
#include <VisionCamera/JHybridCameraControllerSpec.hpp>
...
namespace margelo::nitro::camera {
  ...
  // Methods
  std::shared_ptr<Promise<std::vector<std::shared_ptr<margelo::nitro::camera::HybridCameraControllerSpec>>>> JHybridCameraSessionSpec::configure(const std::vector<CameraSessionConnection>& connections, const std::optional<CameraSessionConfiguration>& config) {
    ...
    return [&]() {
      auto __promise = Promise<std::vector<std::shared_ptr<margelo::nitro::camera::HybridCameraControllerSpec>>>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
        auto __result = jni::static_ref_cast<jni::JArrayClass<margelo::nitro::camera::JHybridCameraControllerSpec::JavaPart>>(__boxedResult);
        __promise->resolve([&](auto&& __input) {
          size_t __size = __input->size();
          std::vector<std::shared_ptr<margelo::nitro::camera::HybridCameraControllerSpec>> __vector;
