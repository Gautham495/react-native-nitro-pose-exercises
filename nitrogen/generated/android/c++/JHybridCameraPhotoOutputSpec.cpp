...
#include <VisionCamera/JHybridPhotoSpec.hpp>
...
namespace margelo::nitro::camera {
  ...
  // Methods
  std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridPhotoSpec>>> JHybridCameraPhotoOutputSpec::capturePhoto(const CapturePhotoSettings& settings, const CapturePhotoCallbacks& callbacks) {
    ...
    return [&]() {
      auto __promise = Promise<std::shared_ptr<margelo::nitro::camera::HybridPhotoSpec>>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
        auto __result = jni::static_ref_cast<margelo::nitro::camera::JHybridPhotoSpec::JavaPart>(__boxedResult);
