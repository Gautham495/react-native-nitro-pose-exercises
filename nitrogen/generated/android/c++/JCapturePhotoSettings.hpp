...
namespace margelo::nitro::nitroposeexercises {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitroposeexercises/CapturePhotoSettings;";
  ...
  public:
    ...
    CapturePhotoSettings toCpp() const {
      ...
      static const auto fieldLocation = clazz->getField<margelo::nitro::camera::JHybridLocationSpec::JavaPart>("location");
      jni::local_ref<margelo::nitro::camera::JHybridLocationSpec::JavaPart> location = this->getFieldValue(fieldLocation);
  ...
  public:
    ...
    static jni::local_ref<JCapturePhotoSettings::javaobject> fromCpp(const CapturePhotoSettings& value) {
      using JSignature = JCapturePhotoSettings(jni::alias_ref<JFlashMode>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<margelo::nitro::camera::JHybridLocationSpec::JavaPart>);
      static const auto clazz = javaClassStatic();
      ...
      return create(
        ...
        value.location.has_value() ? std::dynamic_pointer_cast<margelo::nitro::camera::JHybridLocationSpec>(value.location.value())->getJavaPart() : nullptr
      );
    }
  };
