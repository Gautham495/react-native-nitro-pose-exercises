...
#include <VisionCamera/JHybridRecorderSpec.hpp>
...
namespace margelo::nitro::camera {
  ...
  std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridRecorderSpec>>> JHybridCameraVideoOutputSpec::createRecorder(const RecorderSettings& settings) {
    ...
    return [&]() {
      auto __promise = Promise<std::shared_ptr<margelo::nitro::camera::HybridRecorderSpec>>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
        auto __result = jni::static_ref_cast<margelo::nitro::camera::JHybridRecorderSpec::JavaPart>(__boxedResult);
