...
#include <VisionCamera/JHybridFramePlaneSpec.hpp>
...
namespace margelo::nitro::camera {
  ...
  // Methods
  std::vector<std::shared_ptr<margelo::nitro::camera::HybridFramePlaneSpec>> JHybridFrameSpec::getPlanes() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<margelo::nitro::camera::JHybridFramePlaneSpec::JavaPart>>()>("getPlanes");
    auto __result = method(_javaPart);
    return [&](auto&& __input) {
      size_t __size = __input->size();
      std::vector<std::shared_ptr<margelo::nitro::camera::HybridFramePlaneSpec>> __vector;
