...
namespace margelo::nitro::camera {
   ...
   * ```
   */
  class HybridCameraVideoOutputSpec: public virtual HybridObject, public virtual margelo::nitro::camera::HybridCameraOutputSpec {
    public:
      // Constructor
    ...
    public:
      ...
      virtual std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridRecorderSpec>>> createRecorder(const RecorderSettings& settings) = 0;
