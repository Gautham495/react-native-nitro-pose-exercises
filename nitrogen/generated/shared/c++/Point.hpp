...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitroposeexercises::Point> final {
    static inline margelo::nitro::nitroposeexercises::Point fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitroposeexercises::Point(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitroposeexercises::Point& arg) {
