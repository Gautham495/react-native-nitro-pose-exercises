...
namespace margelo::nitro::camera {
  ...
  class HybridDepthSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraCalibrationDataSpec>> getCameraCalibrationData() = 0;

    public:
      // Methods
      virtual std::shared_ptr<ArrayBuffer> getDepthData() = 0;
      virtual NativeBuffer getNativeBuffer() = 0;
      virtual std::shared_ptr<margelo::nitro::camera::HybridDepthSpec> rotate(CameraOrientation orientation, bool isMirrored) = 0;
      virtual std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridDepthSpec>>> rotateAsync(CameraOrientation orientation, bool isMirrored) = 0;
      virtual std::shared_ptr<margelo::nitro::camera::HybridDepthSpec> convert(DepthPixelFormat pixelFormat) = 0;
      virtual std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridDepthSpec>>> convertAsync(DepthPixelFormat pixelFormat) = 0;
      ...
      virtual std::shared_ptr<margelo::nitro::camera::HybridFrameSpec> toFrame() = 0;
      virtual std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridFrameSpec>>> toFrameAsync() = 0;
