...
namespace margelo::nitro::nitroposeexercises {
  ...
  public:
    ...
    std::optional<std::shared_ptr<margelo::nitro::camera::HybridLocationSpec>> location     SWIFT_PRIVATE;

  public:
    CapturePhotoSettings() = default;
    explicit CapturePhotoSettings(std::optional<FlashMode> flashMode, std::optional<bool> enableShutterSound, std::optional<bool> enableDepthData, std::optional<bool> enableRedEyeReduction, std::optional<bool> enableCameraCalibrationDataDelivery, std::optional<bool> enableDistortionCorrection, std::optional<bool> enableVirtualDeviceFusion, std::optional<std::shared_ptr<margelo::nitro::camera::HybridLocationSpec>> location): flashMode(flashMode), enableShutterSound(enableShutterSound), enableDepthData(enableDepthData), enableRedEyeReduction(enableRedEyeReduction), enableCameraCalibrationDataDelivery(enableCameraCalibrationDataDelivery), enableDistortionCorrection(enableDistortionCorrection), enableVirtualDeviceFusion(enableVirtualDeviceFusion), location(location) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitroposeexercises::CapturePhotoSettings> final {
    static inline margelo::nitro::nitroposeexercises::CapturePhotoSettings fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitroposeexercises::CapturePhotoSettings(
        JSIConverter<std::optional<margelo::nitro::nitroposeexercises::FlashMode>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "flashMode"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitroposeexercises::CapturePhotoSettings& arg) {
      jsi::Object obj(runtime);
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "flashMode"), JSIConverter<std::optional<margelo::nitro::nitroposeexercises::FlashMode>>::toJSI(runtime, arg.flashMode));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<margelo::nitro::nitroposeexercises::FlashMode>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "flashMode")))) return false;
