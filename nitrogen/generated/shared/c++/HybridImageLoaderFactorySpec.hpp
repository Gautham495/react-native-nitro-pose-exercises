...
namespace margelo::nitro::image {
  ...
  class HybridImageLoaderFactorySpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::shared_ptr<margelo::nitro::image::HybridImageLoaderSpec> createRawPixelDataImageLoader(const RawPixelData& data) = 0;
      virtual std::shared_ptr<margelo::nitro::image::HybridImageLoaderSpec> createEncodedImageDataImageLoader(const EncodedImageData& data) = 0;
