...
namespace margelo::nitro::camera {
  ...
  class HybridPhotoSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::optional<std::shared_ptr<margelo::nitro::camera::HybridDepthSpec>> getDepth() = 0;
      virtual std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraCalibrationDataSpec>> getCalibrationData() = 0;
