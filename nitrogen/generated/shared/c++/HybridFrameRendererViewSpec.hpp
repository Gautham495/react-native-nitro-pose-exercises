...
namespace margelo::nitro::camera {
  ...
  class HybridFrameRendererViewSpec: public virtual HybridObject {
    ...
    public:
      // Properties
      virtual std::optional<std::shared_ptr<margelo::nitro::camera::HybridFrameRendererSpec>> getRenderer() = 0;
      virtual void setRenderer(const std::optional<std::shared_ptr<margelo::nitro::camera::HybridFrameRendererSpec>>& renderer) = 0;
