...
namespace margelo::nitro::camera::views {
  ...
  public:
    CachedProp<std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraPreviewOutputSpec>>> previewOutput;
    CachedProp<std::optional<PreviewResizeMode>> resizeMode;
    CachedProp<std::optional<PreviewImplementationMode>> implementationMode;
    CachedProp<std::optional<std::vector<std::shared_ptr<margelo::nitro::camera::HybridGestureControllerSpec>>>> gestureControllers;
    CachedProp<std::optional<std::function<void()>>> onPreviewStarted;
    CachedProp<std::optional<std::function<void()>>> onPreviewStopped;
    CachedProp<std::optional<std::function<void(const std::shared_ptr<margelo::nitro::camera::HybridPreviewViewSpec>& /* ref */)>>> hybridRef;
