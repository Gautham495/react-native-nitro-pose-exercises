...
namespace margelo::nitro::camera::views {
  ...
  HybridPreviewViewProps::HybridPreviewViewProps(const react::PropsParserContext& context,
    ...
    previewOutput([&]() -> CachedProp<std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraPreviewOutputSpec>>> {
      try {
        ...
        return CachedProp<std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraPreviewOutputSpec>>>::fromRawValue(*runtime, value, sourceProps.previewOutput);
    ...
    gestureControllers([&]() -> CachedProp<std::optional<std::vector<std::shared_ptr<margelo::nitro::camera::HybridGestureControllerSpec>>>> {
      try {
        ...
        const auto& [runtime, value] = (std::pair<jsi::Runtime*, jsi::Value>)*rawValue;
        return CachedProp<std::optional<std::vector<std::shared_ptr<margelo::nitro::camera::HybridGestureControllerSpec>>>>::fromRawValue(*runtime, value, sourceProps.gestureControllers);
      } catch (const std::exception& exc) {
    ...
    hybridRef([&]() -> CachedProp<std::optional<std::function<void(const std::shared_ptr<margelo::nitro::camera::HybridPreviewViewSpec>& /* ref */)>>> {
      try {
        const react::RawValue* rawValue = rawProps.at("hybridRef", nullptr, nullptr);
        if (rawValue == nullptr) return sourceProps.hybridRef;
        const auto& [runtime, value] = (std::pair<jsi::Runtime*, jsi::Value>)*rawValue;
        return CachedProp<std::optional<std::function<void(const std::shared_ptr<margelo::nitro::camera::HybridPreviewViewSpec>& /* ref */)>>>::fromRawValue(*runtime, value.asObject(*runtime).getProperty(*runtime, PropNameIDCache::get(*runtime, "f")), sourceProps.hybridRef);
      } catch (const std::exception& exc) {
