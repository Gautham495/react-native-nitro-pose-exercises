...
namespace margelo::nitro::camera::views {
  ...
  HybridFrameRendererViewProps::HybridFrameRendererViewProps(const react::PropsParserContext& context,
    ...
    renderer([&]() -> CachedProp<std::optional<std::shared_ptr<margelo::nitro::camera::HybridFrameRendererSpec>>> {
      try {
        ...
        return CachedProp<std::optional<std::shared_ptr<margelo::nitro::camera::HybridFrameRendererSpec>>>::fromRawValue(*runtime, value, sourceProps.renderer);
      } catch (const std::exception& exc) {
        throw std::runtime_error(std::string("FrameRendererView.renderer: ") + exc.what());
      }
    }()),
    hybridRef([&]() -> CachedProp<std::optional<std::function<void(const std::shared_ptr<margelo::nitro::camera::HybridFrameRendererViewSpec>& /* ref */)>>> {
      try {
        const react::RawValue* rawValue = rawProps.at("hybridRef", nullptr, nullptr);
        if (rawValue == nullptr) return sourceProps.hybridRef;
        const auto& [runtime, value] = (std::pair<jsi::Runtime*, jsi::Value>)*rawValue;
        return CachedProp<std::optional<std::function<void(const std::shared_ptr<margelo::nitro::camera::HybridFrameRendererViewSpec>& /* ref */)>>>::fromRawValue(*runtime, value.asObject(*runtime).getProperty(*runtime, PropNameIDCache::get(*runtime, "f")), sourceProps.hybridRef);
      } catch (const std::exception& exc) {
