...
namespace margelo::nitro::camera::views {
  ...
  public:
    CachedProp<std::optional<std::shared_ptr<margelo::nitro::camera::HybridFrameRendererSpec>>> renderer;
    CachedProp<std::optional<std::function<void(const std::shared_ptr<margelo::nitro::camera::HybridFrameRendererViewSpec>& /* ref */)>>> hybridRef;
