...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitroposeexercises::CapturePhotoCallbacks> final {
    static inline margelo::nitro::nitroposeexercises::CapturePhotoCallbacks fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitroposeexercises::CapturePhotoCallbacks(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitroposeexercises::CapturePhotoCallbacks& arg) {
