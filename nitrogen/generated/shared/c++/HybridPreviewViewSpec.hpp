...
namespace margelo::nitro::camera {
  ...
  class HybridPreviewViewSpec: public virtual HybridObject {
    ...
    public:
      // Properties
      virtual std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraPreviewOutputSpec>> getPreviewOutput() = 0;
      virtual void setPreviewOutput(const std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraPreviewOutputSpec>>& previewOutput) = 0;
      ...
      virtual std::optional<std::vector<std::shared_ptr<margelo::nitro::camera::HybridGestureControllerSpec>>> getGestureControllers() = 0;
      virtual void setGestureControllers(const std::optional<std::vector<std::shared_ptr<margelo::nitro::camera::HybridGestureControllerSpec>>>& gestureControllers) = 0;
    ...
    public:
      // Methods
      virtual std::shared_ptr<margelo::nitro::camera::HybridMeteringPointSpec> createMeteringPoint(double viewX, double viewY, std::optional<double> size) = 0;
      ...
      virtual std::shared_ptr<margelo::nitro::camera::HybridScannedObjectSpec> convertScannedObjectCoordinatesToViewCoordinates(const std::shared_ptr<margelo::nitro::camera::HybridScannedObjectSpec>& scannedObject) = 0;
