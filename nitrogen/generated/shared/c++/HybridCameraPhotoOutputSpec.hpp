...
namespace margelo::nitro::camera {
   ...
   * ```
   */
  class HybridCameraPhotoOutputSpec: public virtual HybridObject, public virtual margelo::nitro::camera::HybridCameraOutputSpec {
    public:
      // Constructor
    ...
    public:
      // Methods
      virtual std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridPhotoSpec>>> capturePhoto(const CapturePhotoSettings& settings, const CapturePhotoCallbacks& callbacks) = 0;
