...
namespace margelo::nitro::camera {
   ...
   * ```
   */
  class HybridCameraDepthFrameOutputSpec: public virtual HybridObject, public virtual margelo::nitro::camera::HybridCameraOutputSpec {
    public:
      // Constructor
    ...
    public:
      // Methods
      virtual void setOnDepthFrameCallback(const std::optional<std::function<bool(const std::shared_ptr<margelo::nitro::camera::HybridDepthSpec>& /* depth */)>>& onDepthFrame) = 0;
