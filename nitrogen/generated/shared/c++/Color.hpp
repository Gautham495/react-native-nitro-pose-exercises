...
namespace margelo::nitro::nitroposeexercises {
  ...
  /**
   * A struct which can be represented as a JavaScript object (Color).
   */
  struct Color final {
  public:
    ...
    std::optional<double> a     SWIFT_PRIVATE;

  public:
    Color() = default;
    explicit Color(double r, double g, double b, std::optional<double> a): r(r), g(g), b(b), a(a) {}
...
namespace margelo::nitro {
  ...
  // C++ Color <> JS Color (object)
  template <>
  struct JSIConverter<margelo::nitro::nitroposeexercises::Color> final {
    static inline margelo::nitro::nitroposeexercises::Color fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitroposeexercises::Color(
        ...
        JSIConverter<std::optional<double>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "a")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitroposeexercises::Color& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "a"), JSIConverter<std::optional<double>>::toJSI(runtime, arg.a));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<double>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "a")))) return false;
      return true;
    }
  };
