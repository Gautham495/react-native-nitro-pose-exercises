...
namespace margelo::nitro::camera {
  ...
  class HybridCameraControllerSpec: public virtual HybridObject {
    ...
    public:
      // Properties
      virtual std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec> getDevice() = 0;
    ...
    public:
      ...
      virtual std::shared_ptr<Promise<void>> focusTo(const std::shared_ptr<margelo::nitro::camera::HybridMeteringPointSpec>& point, const FocusOptions& options) = 0;
