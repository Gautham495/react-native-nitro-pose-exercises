...
namespace margelo::nitro::camera {
  ...
  class HybridCameraDeviceSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::vector<std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>> getPhysicalDevices() = 0;
      ...
      virtual std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>> getCompanionDeskViewCamera() = 0;
    ...
    public:
      ...
      virtual bool supportsOutput(const std::shared_ptr<margelo::nitro::camera::HybridCameraOutputSpec>& output) = 0;
      ...
      virtual bool isSessionConfigSupported(const std::shared_ptr<margelo::nitro::camera::HybridCameraSessionConfigSpec>& config) = 0;
