...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitroposeexercises::CameraSessionConfiguration> final {
    static inline margelo::nitro::nitroposeexercises::CameraSessionConfiguration fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitroposeexercises::CameraSessionConfiguration(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitroposeexercises::CameraSessionConfiguration& arg) {
