...
namespace margelo::nitro::nitroposeexercises {
  ...
  public:
    ...
    explicit RecorderSettings(std::optional<std::shared_ptr<margelo::nitro::camera::HybridLocationSpec>> location, std::optional<std::string> filePath, std::optional<double> maxDuration, std::optional<double> maxFileSize): location(location), filePath(filePath), maxDuration(maxDuration), maxFileSize(maxFileSize) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitroposeexercises::RecorderSettings> final {
    static inline margelo::nitro::nitroposeexercises::RecorderSettings fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitroposeexercises::RecorderSettings(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitroposeexercises::RecorderSettings& arg) {
