...
open class HybridPreviewViewSpec_cxx {
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_margelo__nitro__camera__HybridPreviewViewSpec_
   ...
   * The C++ part is a `std::shared_ptr<margelo::nitro::camera::HybridPreviewViewSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_margelo__nitro__camera__HybridPreviewViewSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if Bool(fromCxx: cachedCxxPart) {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_margelo__nitro__camera__HybridPreviewViewSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_margelo__nitro__camera__HybridPreviewViewSpec_(newCxxPart)
      return newCxxPart
    }
  }
  ...
  // Properties
  public final var previewOutput: bridge.std__optional_std__shared_ptr_margelo__nitro__camera__HybridCameraPreviewOutputSpec__ {
    @inline(__always)
    get {
      return { () -> bridge.std__optional_std__shared_ptr_margelo__nitro__camera__HybridCameraPreviewOutputSpec__ in
        if let __unwrappedValue = self.__implementation.previewOutput {
          return bridge.create_std__optional_std__shared_ptr_margelo__nitro__camera__HybridCameraPreviewOutputSpec__({ () -> bridge.std__shared_ptr_margelo__nitro__camera__HybridCameraPreviewOutputSpec_ in
    ...
    set {
      self.__implementation.previewOutput = { () -> (any HybridCameraPreviewOutputSpec)? in
        if bridge.has_value_std__optional_std__shared_ptr_margelo__nitro__camera__HybridCameraPreviewOutputSpec__(newValue) {
          let __unwrapped = bridge.get_std__optional_std__shared_ptr_margelo__nitro__camera__HybridCameraPreviewOutputSpec__(newValue)
          return { () -> any HybridCameraPreviewOutputSpec in
            let __unsafePointer = bridge.get_std__shared_ptr_margelo__nitro__camera__HybridCameraPreviewOutputSpec_(__unwrapped)
  ...
  public final var gestureControllers: bridge.std__optional_std__vector_std__shared_ptr_margelo__nitro__camera__HybridGestureControllerSpec___ {
    @inline(__always)
    get {
      return { () -> bridge.std__optional_std__vector_std__shared_ptr_margelo__nitro__camera__HybridGestureControllerSpec___ in
        if let __unwrappedValue = self.__implementation.gestureControllers {
          return bridge.create_std__optional_std__vector_std__shared_ptr_margelo__nitro__camera__HybridGestureControllerSpec___({ () -> bridge.std__vector_std__shared_ptr_margelo__nitro__camera__HybridGestureControllerSpec__ in
            var __vector = bridge.create_std__vector_std__shared_ptr_margelo__nitro__camera__HybridGestureControllerSpec__(__unwrappedValue.count)
            for __item in __unwrappedValue {
              __vector.push_back({ () -> bridge.std__shared_ptr_margelo__nitro__camera__HybridGestureControllerSpec_ in
    ...
    set {
      self.__implementation.gestureControllers = { () -> [(any HybridGestureControllerSpec)]? in
        if bridge.has_value_std__optional_std__vector_std__shared_ptr_margelo__nitro__camera__HybridGestureControllerSpec___(newValue) {
          let __unwrapped = bridge.get_std__optional_std__vector_std__shared_ptr_margelo__nitro__camera__HybridGestureControllerSpec___(newValue)
          return __unwrapped.map({ __item in { () -> any HybridGestureControllerSpec in
            let __unsafePointer = bridge.get_std__shared_ptr_margelo__nitro__camera__HybridGestureControllerSpec_(__item)
  ...
  // Methods
  @inline(__always)
  public final func createMeteringPoint(viewX: Double, viewY: Double, size: bridge.std__optional_double_) -> bridge.Result_std__shared_ptr_margelo__nitro__camera__HybridMeteringPointSpec__ {
    do {
  ...
  @inline(__always)
  public final func convertScannedObjectCoordinatesToViewCoordinates(scannedObject: bridge.std__shared_ptr_margelo__nitro__camera__HybridScannedObjectSpec_) -> bridge.Result_std__shared_ptr_margelo__nitro__camera__HybridScannedObjectSpec__ {
    do {
      let __result = try self.__implementation.convertScannedObjectCoordinatesToViewCoordinates(scannedObject: { () -> any HybridScannedObjectSpec in
        let __unsafePointer = bridge.get_std__shared_ptr_margelo__nitro__camera__HybridScannedObjectSpec_(scannedObject)
        let __instance = HybridScannedObjectSpec_cxx.fromUnsafe(__unsafePointer)
        return __instance.getHybridScannedObjectSpec()
      }())
      let __resultCpp = { () -> bridge.std__shared_ptr_margelo__nitro__camera__HybridScannedObjectSpec_ in
        let __cxxWrapped = __result.getCxxWrapper()
        return __cxxWrapped.getCxxPart()
      }()
      return bridge.create_Result_std__shared_ptr_margelo__nitro__camera__HybridScannedObjectSpec__(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__shared_ptr_margelo__nitro__camera__HybridScannedObjectSpec__(__exceptionPtr)
    }
  }
