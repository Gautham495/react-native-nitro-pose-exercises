...
open class HybridCameraControllerSpec_cxx {
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_margelo__nitro__camera__HybridCameraControllerSpec_
   ...
   * The C++ part is a `std::shared_ptr<margelo::nitro::camera::HybridCameraControllerSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_margelo__nitro__camera__HybridCameraControllerSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if Bool(fromCxx: cachedCxxPart) {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_margelo__nitro__camera__HybridCameraControllerSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_margelo__nitro__camera__HybridCameraControllerSpec_(newCxxPart)
      return newCxxPart
    }
  }
  ...
  // Properties
  public final var device: bridge.std__shared_ptr_margelo__nitro__camera__HybridCameraDeviceSpec_ {
    @inline(__always)
    get {
      return { () -> bridge.std__shared_ptr_margelo__nitro__camera__HybridCameraDeviceSpec_ in
  ...
  @inline(__always)
  public final func focusTo(point: bridge.std__shared_ptr_margelo__nitro__camera__HybridMeteringPointSpec_, options: FocusOptions) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.focusTo(point: { () -> any HybridMeteringPointSpec in
        let __unsafePointer = bridge.get_std__shared_ptr_margelo__nitro__camera__HybridMeteringPointSpec_(point)
  ...
  public final func setTorchMode(mode: Int32) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.setTorchMode(mode: margelo.nitro.nitroposeexercises.TorchMode(rawValue: mode)!)
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_void__ in
        let __promise = bridge.create_std__shared_ptr_Promise_void__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_void__(__promise)
        __result
