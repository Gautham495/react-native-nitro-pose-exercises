  ...
  public final var image: bridge.std__optional_std__variant_std__shared_ptr_margelo__nitro__image__HybridImageSpec___std__shared_ptr_margelo__nitro__image__HybridImageLoaderSpec___ {
    ...
    set {
      self.__implementation.image = { () -> Variant__any_HybridImageSpec___any_HybridImageLoaderSpec_? in
        if bridge.has_value_std__optional_std__variant_std__shared_ptr_margelo__nitro__image__HybridImageSpec___std__shared_ptr_margelo__nitro__image__HybridImageLoaderSpec___(newValue) {
          let __unwrapped = bridge.get_std__optional_std__variant_std__shared_ptr_margelo__nitro__image__HybridImageSpec___std__shared_ptr_margelo__nitro__image__HybridImageLoaderSpec___(newValue)
