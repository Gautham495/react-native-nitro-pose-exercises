...
open class HybridImageLoaderFactorySpec_cxx {
  ...
  @inline(__always)
  public final func createRawPixelDataImageLoader(data: RawPixelData) -> bridge.Result_std__shared_ptr_margelo__nitro__image__HybridImageLoaderSpec__ {
    do {
  ...
  @inline(__always)
  public final func createEncodedImageDataImageLoader(data: EncodedImageData) -> bridge.Result_std__shared_ptr_margelo__nitro__image__HybridImageLoaderSpec__ {
    do {
