...
open class HybridScannedCodeSpec_cxx : HybridScannedObjectSpec_cxx {
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_margelo__nitro__camera__HybridScannedCodeSpec_
   ...
   * The C++ part is a `std::shared_ptr<margelo::nitro::camera::HybridScannedCodeSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_margelo__nitro__camera__HybridScannedCodeSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if Bool(fromCxx: cachedCxxPart) {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_margelo__nitro__camera__HybridScannedCodeSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_margelo__nitro__camera__HybridScannedCodeSpec_(newCxxPart)
      return newCxxPart
    }
  }

  public override func getCxxPart() -> bridge.std__shared_ptr_margelo__nitro__camera__HybridScannedObjectSpec_ {
    let ownCxxPart: bridge.std__shared_ptr_margelo__nitro__camera__HybridScannedCodeSpec_ = getCxxPart()
