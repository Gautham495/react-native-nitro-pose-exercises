...
open class HybridFrameSpec_cxx {
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_margelo__nitro__camera__HybridFrameSpec_
   ...
   * The C++ part is a `std::shared_ptr<margelo::nitro::camera::HybridFrameSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_margelo__nitro__camera__HybridFrameSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if Bool(fromCxx: cachedCxxPart) {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_margelo__nitro__camera__HybridFrameSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_margelo__nitro__camera__HybridFrameSpec_(newCxxPart)
      return newCxxPart
    }
  }
   ...
   */
  @inline(__always)
  public func equals(other: HybridFrameSpec_cxx) -> Bool {
  ...
  public final var cameraIntrinsicMatrix: bridge.std__optional_std__vector_double__ {
    ...
    get {
      return { () -> bridge.std__optional_std__vector_double__ in
        if let __unwrappedValue = self.__implementation.cameraIntrinsicMatrix {
  ...
  // Methods
  @inline(__always)
  public final func getPlanes() -> bridge.Result_std__vector_std__shared_ptr_margelo__nitro__camera__HybridFramePlaneSpec___ {
    do {
      let __result = try self.__implementation.getPlanes()
      let __resultCpp = { () -> bridge.std__vector_std__shared_ptr_margelo__nitro__camera__HybridFramePlaneSpec__ in
        var __vector = bridge.create_std__vector_std__shared_ptr_margelo__nitro__camera__HybridFramePlaneSpec__(__result.count)
        for __item in __result {
          __vector.push_back({ () -> bridge.std__shared_ptr_margelo__nitro__camera__HybridFramePlaneSpec_ in
      ...
      return bridge.create_Result_std__vector_std__shared_ptr_margelo__nitro__camera__HybridFramePlaneSpec___(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__vector_std__shared_ptr_margelo__nitro__camera__HybridFramePlaneSpec___(__exceptionPtr)
    }
  }
  ...
  public final func convertCameraPointToFramePoint(cameraPoint: Point) -> bridge.Result_Point_ {
    do {
      let __result = try self.__implementation.convertCameraPointToFramePoint(cameraPoint: cameraPoint)
      let __resultCpp = __result
  ...
  public final func convertFramePointToCameraPoint(framePoint: Point) -> bridge.Result_Point_ {
    do {
      let __result = try self.__implementation.convertFramePointToCameraPoint(framePoint: framePoint)
      let __resultCpp = __result
      return bridge.create_Result_Point_(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
