 ...
 */
public typealias CameraSessionConnection = margelo.nitro.nitroposeexercises.CameraSessionConnection
...
public extension CameraSessionConnection {
  ...
  init(input: (any HybridCameraDeviceSpec), outputs: [CameraOutputConfiguration], constraints: [Constraint], initialZoom: Double?, initialExposureBias: Double?, onSessionConfigSelected: ((_ config: (any HybridCameraSessionConfigSpec)) -> Void)?) {
    self.init({ () -> bridge.std__shared_ptr_margelo__nitro__camera__HybridCameraDeviceSpec_ in
    ...
    }(), { () -> bridge.std__optional_std__function_void_const_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec______config______ in
      if let __unwrappedValue = onSessionConfigSelected {
        return bridge.create_std__optional_std__function_void_const_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec______config______({ () -> bridge.Func_void_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec_ in
          let __closureWrapper = Func_void_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec_(__unwrappedValue)
          return bridge.create_Func_void_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec_(__closureWrapper.toUnsafe())
        }())
      } else {
        return .init()
      }
  ...
  var input: (any HybridCameraDeviceSpec) {
    return { () -> any HybridCameraDeviceSpec in
      let __unsafePointer = bridge.get_std__shared_ptr_margelo__nitro__camera__HybridCameraDeviceSpec_(self.__input)
  ...
  var onSessionConfigSelected: ((_ config: (any HybridCameraSessionConfigSpec)) -> Void)? {
    return { () -> ((_ config: (any HybridCameraSessionConfigSpec)) -> Void)? in
      if bridge.has_value_std__optional_std__function_void_const_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec______config______(self.__onSessionConfigSelected) {
        let __unwrapped = bridge.get_std__optional_std__function_void_const_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec______config______(self.__onSessionConfigSelected)
        return { () -> ((any HybridCameraSessionConfigSpec)) -> Void in
          let __wrappedFunction = bridge.wrap_Func_void_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec_(__unwrapped)
          return { (__config: (any HybridCameraSessionConfigSpec)) -> Void in
            __wrappedFunction.call({ () -> bridge.std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec_ in
