...
open class HybridCameraDeviceSpec_cxx {
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_margelo__nitro__camera__HybridCameraDeviceSpec_
   ...
   * The C++ part is a `std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_margelo__nitro__camera__HybridCameraDeviceSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if Bool(fromCxx: cachedCxxPart) {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_margelo__nitro__camera__HybridCameraDeviceSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_margelo__nitro__camera__HybridCameraDeviceSpec_(newCxxPart)
      return newCxxPart
    }
  }
  ...
  public final var physicalDevices: bridge.std__vector_std__shared_ptr_margelo__nitro__camera__HybridCameraDeviceSpec__ {
    @inline(__always)
    get {
      return { () -> bridge.std__vector_std__shared_ptr_margelo__nitro__camera__HybridCameraDeviceSpec__ in
        var __vector = bridge.create_std__vector_std__shared_ptr_margelo__nitro__camera__HybridCameraDeviceSpec__(self.__implementation.physicalDevices.count)
  ...
  public final var companionDeskViewCamera: bridge.std__optional_std__shared_ptr_margelo__nitro__camera__HybridCameraDeviceSpec__ {
    @inline(__always)
    get {
  ...
  public final func getSupportedResolutions(outputStreamType: Int32) -> bridge.Result_std__vector_Size__ {
    do {
      let __result = try self.__implementation.getSupportedResolutions(outputStreamType: margelo.nitro.nitroposeexercises.OutputStreamType(rawValue: outputStreamType)!)
  ...
  @inline(__always)
  public final func supportsOutput(output: bridge.std__shared_ptr_margelo__nitro__camera__HybridCameraOutputSpec_) -> bridge.Result_bool_ {
    do {
      let __result = try self.__implementation.supportsOutput(output: { () -> any HybridCameraOutputSpec in
        let __unsafePointer = bridge.get_std__shared_ptr_margelo__nitro__camera__HybridCameraOutputSpec_(output)
  ...
  public final func supportsVideoStabilizationMode(videoStabilizationMode: Int32) -> bridge.Result_bool_ {
    do {
      let __result = try self.__implementation.supportsVideoStabilizationMode(videoStabilizationMode: margelo.nitro.nitroposeexercises.TargetStabilizationMode(rawValue: videoStabilizationMode)!)
      let __resultCpp = __result
      return bridge.create_Result_bool_(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
  ...
  public final func supportsPreviewStabilizationMode(previewStabilizationMode: Int32) -> bridge.Result_bool_ {
    do {
      let __result = try self.__implementation.supportsPreviewStabilizationMode(previewStabilizationMode: margelo.nitro.nitroposeexercises.TargetStabilizationMode(rawValue: previewStabilizationMode)!)
      let __resultCpp = __result
      return bridge.create_Result_bool_(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
  ...
  @inline(__always)
  public final func isSessionConfigSupported(config: bridge.std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec_) -> bridge.Result_bool_ {
    do {
      let __result = try self.__implementation.isSessionConfigSupported(config: { () -> any HybridCameraSessionConfigSpec in
        let __unsafePointer = bridge.get_std__shared_ptr_margelo__nitro__camera__HybridCameraSessionConfigSpec_(config)
