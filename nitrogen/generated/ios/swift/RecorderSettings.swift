 ...
 */
public typealias RecorderSettings = margelo.nitro.nitroposeexercises.RecorderSettings
...
public extension RecorderSettings {
  ...
  init(location: (any HybridLocationSpec)?, filePath: String?, maxDuration: Double?, maxFileSize: Double?) {
    self.init({ () -> bridge.std__optional_std__shared_ptr_margelo__nitro__camera__HybridLocationSpec__ in
  ...
  var location: (any HybridLocationSpec)? {
    return { () -> (any HybridLocationSpec)? in
      if bridge.has_value_std__optional_std__shared_ptr_margelo__nitro__camera__HybridLocationSpec__(self.__location) {
        let __unwrapped = bridge.get_std__optional_std__shared_ptr_margelo__nitro__camera__HybridLocationSpec__(self.__location)
        return { () -> any HybridLocationSpec in
          let __unsafePointer = bridge.get_std__shared_ptr_margelo__nitro__camera__HybridLocationSpec_(__unwrapped)
