...
namespace margelo::nitro::camera {
  ...
  public:
    // Properties
    inline std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraPreviewOutputSpec>> getPreviewOutput() noexcept override {
      auto __result = _swiftPart.getPreviewOutput();
      return __result;
    }
    inline void setPreviewOutput(const std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraPreviewOutputSpec>>& previewOutput) noexcept override {
    ...
    inline std::optional<std::vector<std::shared_ptr<margelo::nitro::camera::HybridGestureControllerSpec>>> getGestureControllers() noexcept override {
      auto __result = _swiftPart.getGestureControllers();
      return __result;
    }
    inline void setGestureControllers(const std::optional<std::vector<std::shared_ptr<margelo::nitro::camera::HybridGestureControllerSpec>>>& gestureControllers) noexcept override {
  ...
  public:
    // Methods
    inline std::shared_ptr<margelo::nitro::camera::HybridMeteringPointSpec> createMeteringPoint(double viewX, double viewY, std::optional<double> size) override {
    ...
    inline std::shared_ptr<margelo::nitro::camera::HybridScannedObjectSpec> convertScannedObjectCoordinatesToViewCoordinates(const std::shared_ptr<margelo::nitro::camera::HybridScannedObjectSpec>& scannedObject) override {
