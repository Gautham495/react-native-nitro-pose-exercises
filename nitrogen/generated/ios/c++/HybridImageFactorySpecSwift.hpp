...
namespace margelo::nitro::image {
  ...
  public:
    // Methods
    inline std::shared_ptr<margelo::nitro::image::HybridImageSpec> createBlankImage(double width, double height, bool enableAlpha, const std::optional<Color>& fill) override {
    ...
    inline std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::image::HybridImageSpec>>> createBlankImageAsync(double width, double height, bool enableAlpha, const std::optional<Color>& fill) override {
    ...
    inline std::shared_ptr<margelo::nitro::image::HybridImageSpec> loadFromRawPixelData(const RawPixelData& data, std::optional<bool> allowGpu) override {
    ...
    inline std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::image::HybridImageSpec>>> loadFromRawPixelDataAsync(const RawPixelData& data, std::optional<bool> allowGpu) override {
    ...
    inline std::shared_ptr<margelo::nitro::image::HybridImageSpec> loadFromEncodedImageData(const EncodedImageData& data) override {
    ...
    inline std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::image::HybridImageSpec>>> loadFromEncodedImageDataAsync(const EncodedImageData& data) override {
