...
- (instancetype) init {
  if (self = [super init]) {
    std::shared_ptr<HybridNitroImageViewSpec> hybridView = NitroPoseExercises::NitroPoseExercisesAutolinking::createNitroImageView();
...
+ (BOOL)shouldBeRecycled {
  return NitroPoseExercises::NitroPoseExercisesAutolinking::isNitroImageViewRecyclable();
}
