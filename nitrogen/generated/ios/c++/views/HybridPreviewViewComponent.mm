...
- (instancetype) init {
  if (self = [super init]) {
    std::shared_ptr<HybridPreviewViewSpec> hybridView = NitroPoseExercises::NitroPoseExercisesAutolinking::createPreviewView();
...
+ (BOOL)shouldBeRecycled {
  return NitroPoseExercises::NitroPoseExercisesAutolinking::isPreviewViewRecyclable();
}
