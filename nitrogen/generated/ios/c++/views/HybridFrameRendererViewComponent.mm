...
- (instancetype) init {
  if (self = [super init]) {
    std::shared_ptr<HybridFrameRendererViewSpec> hybridView = NitroPoseExercises::NitroPoseExercisesAutolinking::createFrameRendererView();
...
+ (BOOL)shouldBeRecycled {
  return NitroPoseExercises::NitroPoseExercisesAutolinking::isFrameRendererViewRecyclable();
}
