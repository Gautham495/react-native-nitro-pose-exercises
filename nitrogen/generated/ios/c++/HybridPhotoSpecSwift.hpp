...
namespace margelo::nitro::camera {
  ...
  public:
    ...
    inline std::optional<std::shared_ptr<margelo::nitro::camera::HybridDepthSpec>> getDepth() noexcept override {
      auto __result = _swiftPart.getDepth();
      return __result;
    }
    inline std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraCalibrationDataSpec>> getCalibrationData() noexcept override {
