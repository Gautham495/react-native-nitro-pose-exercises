...
namespace margelo::nitro::camera {
  ...
  public:
    ...
    bool equals(const std::shared_ptr<HybridObject>& other) override {
      if (auto otherCast = std::dynamic_pointer_cast<HybridCameraFrameOutputSpecSwift>(other)) {
  ...
  public:
    // Methods
    inline void setOnFrameCallback(const std::optional<std::function<bool(const std::shared_ptr<margelo::nitro::camera::HybridFrameSpec>& /* frame */)>>& onFrame) override {
