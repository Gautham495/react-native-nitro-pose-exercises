...
namespace margelo::nitro::camera {
  ...
  public:
    // Methods
    inline std::shared_ptr<Promise<std::vector<std::shared_ptr<margelo::nitro::camera::HybridCameraControllerSpec>>>> configure(const std::vector<CameraSessionConnection>& connections, const std::optional<CameraSessionConfiguration>& config) override {
