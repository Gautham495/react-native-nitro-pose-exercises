...
namespace margelo::nitro::camera {
  ...
  public:
    ...
    bool equals(const std::shared_ptr<HybridObject>& other) override {
      if (auto otherCast = std::dynamic_pointer_cast<HybridCameraDepthFrameOutputSpecSwift>(other)) {
  ...
  public:
    // Methods
    inline void setOnDepthFrameCallback(const std::optional<std::function<bool(const std::shared_ptr<margelo::nitro::camera::HybridDepthSpec>& /* depth */)>>& onDepthFrame) override {
