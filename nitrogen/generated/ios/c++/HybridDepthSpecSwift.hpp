...
namespace margelo::nitro::camera {
  ...
  public:
    ...
    inline std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraCalibrationDataSpec>> getCameraCalibrationData() noexcept override {
  ...
  public:
    ...
    inline std::shared_ptr<margelo::nitro::camera::HybridDepthSpec> rotate(CameraOrientation orientation, bool isMirrored) override {
    ...
    inline std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridDepthSpec>>> rotateAsync(CameraOrientation orientation, bool isMirrored) override {
    ...
    inline std::shared_ptr<margelo::nitro::camera::HybridDepthSpec> convert(DepthPixelFormat pixelFormat) override {
    ...
    inline std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridDepthSpec>>> convertAsync(DepthPixelFormat pixelFormat) override {
    ...
    inline std::shared_ptr<margelo::nitro::camera::HybridFrameSpec> toFrame() override {
    ...
    inline std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridFrameSpec>>> toFrameAsync() override {
