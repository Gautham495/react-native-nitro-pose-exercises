...
namespace margelo::nitro::camera {
  ...
  public:
    // Methods
    inline std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::camera::HybridPhotoSpec>>> capturePhoto(const CapturePhotoSettings& settings, const CapturePhotoCallbacks& callbacks) override {
