...
namespace margelo::nitro::camera {
  ...
  public:
    // Properties
    inline std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec> getDevice() noexcept override {
  ...
  public:
    ...
    inline std::shared_ptr<Promise<void>> focusTo(const std::shared_ptr<margelo::nitro::camera::HybridMeteringPointSpec>& point, const FocusOptions& options) override {
