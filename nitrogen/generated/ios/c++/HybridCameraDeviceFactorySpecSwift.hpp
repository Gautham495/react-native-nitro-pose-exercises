...
namespace margelo::nitro::camera {
  ...
  public:
    // Properties
    inline std::vector<std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>> getCameraDevices() noexcept override {
      auto __result = _swiftPart.getCameraDevices();
      return __result;
    }
    inline std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>> getUserPreferredCamera() noexcept override {
      auto __result = _swiftPart.getUserPreferredCamera();
      return __result;
    }
    inline void setUserPreferredCamera(const std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>>& userPreferredCamera) noexcept override {
      _swiftPart.setUserPreferredCamera(userPreferredCamera);
    }
    inline std::vector<std::vector<std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>>> getSupportedMultiCamDeviceCombinations() noexcept override {
  ...
  public:
    // Methods
    inline ListenerSubscription addOnCameraDevicesChangedListener(const std::function<void(const std::vector<std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>>& /* newDevices */)>& listener) override {
    ...
    inline std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>> getCameraForId(const std::string& id) override {
    ...
    inline std::shared_ptr<Promise<std::vector<std::shared_ptr<margelo::nitro::camera::HybridCameraExtensionSpec>>>> getSupportedExtensions(const std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>& camera) override {
    ...
    inline std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>> getDefaultCamera(CameraPosition position) override {
