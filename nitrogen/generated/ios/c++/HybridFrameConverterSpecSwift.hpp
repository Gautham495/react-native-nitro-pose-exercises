...
namespace margelo::nitro::camera {
  ...
  public:
    // Methods
    inline std::shared_ptr<margelo::nitro::image::HybridImageSpec> convertFrameToImage(const std::shared_ptr<margelo::nitro::camera::HybridFrameSpec>& frame) override {
    ...
    inline std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::image::HybridImageSpec>>> convertFrameToImageAsync(const std::shared_ptr<margelo::nitro::camera::HybridFrameSpec>& frame) override {
    ...
    inline std::shared_ptr<margelo::nitro::image::HybridImageSpec> convertDepthToImage(const std::shared_ptr<margelo::nitro::camera::HybridDepthSpec>& depth) override {
    ...
    inline std::shared_ptr<Promise<std::shared_ptr<margelo::nitro::image::HybridImageSpec>>> convertDepthToImageAsync(const std::shared_ptr<margelo::nitro::camera::HybridDepthSpec>& depth) override {
