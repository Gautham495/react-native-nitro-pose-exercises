...
namespace margelo::nitro::camera {
  ...
  public:
    ...
    inline std::vector<std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>> getPhysicalDevices() noexcept override {
    ...
    inline std::optional<std::shared_ptr<margelo::nitro::camera::HybridCameraDeviceSpec>> getCompanionDeskViewCamera() noexcept override {
  ...
  public:
    ...
    inline bool supportsOutput(const std::shared_ptr<margelo::nitro::camera::HybridCameraOutputSpec>& output) override {
    ...
    inline bool isSessionConfigSupported(const std::shared_ptr<margelo::nitro::camera::HybridCameraSessionConfigSpec>& config) override {
